...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/icub-main-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/icub-main-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add icub-main icub-main-python libicub-main
# for installing globally
pixi global install icub-main icub-main-python libicub-main
```
...
It is possible to list all of the versions of `icub-main` available on your platform:
...
```
pixi search icub-main --channel conda-forge
```
